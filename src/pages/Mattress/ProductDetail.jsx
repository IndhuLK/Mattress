...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const q = query(
          collection(db, "mattressProducts"),
          where("sku", "==", sku)
        );
          ...
          <div className="grid lg:grid-cols-2 gap-8 bg-white p-8 rounded-2xl shadow-lg">
              ...
              <table className="w-full border-collapse">
                <tbody className="text-gray-700">
                  {[
                    ...
                    ["Included", "1 Mattress, User Manual, Warranty Card"],
                  ].map(([label, value]) => (
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                DreamEase Orthopedic Memory Foam Mattress. Designed to align
                your spine naturally, it provides balanced pressure relief for
                every sleeping position. The multi-layer construction ensures
                that your body gets personalized contouring while maintaining
                consistent firmness.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                The breathable outer fabric promotes air circulation, keeping
                the mattress cool and hygienic even during warm nights. Say
                goodbye to back pain and restless sleep — and wake up refreshed
                every morning.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="lg:w-1/2 space-y-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                to your body shape, evenly distributing weight and reducing
                motion transfer. Whether you sleep on your back or side, it
                provides personalized comfort that supports healthy posture.
              </p>
              <p className="text-gray-700 leading-relaxed">
