      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 bg-white p-8 rounded-2xl shadow-lg">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The hollow fiber filling ensures breathability and bounce, so your
              pillow never goes flat. It’s designed for every sleeping position,
              making it the ideal choice for those who value restful, healthy
              sleep.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              gentle neck alignment and relieving stress points while you rest.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Its premium micro-fiber shell adds a luxurious touch, keeping the
              pillow cool and breathable even during warm nights.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-col-reverse lg:flex-row items-center gap-10">
          <div className="lg:w-1/2 space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Engineered with dense hollow fibers and double-stitched edges, the
              CloudRest Pillow retains its shape and loft even after long-term
              use. No sagging, no lumps — just consistent comfort.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Whether you’re relaxing after a long day or getting ready for a
              deep sleep, this pillow promises durability and a plush feel that
              lasts for years.
            </p>
          </div>
          <div className="lg:w-1/2">
